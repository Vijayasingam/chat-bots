...
gems_sr_nbr.addMatch(new RegExp("SR-[A-Z]{2}-[0-9]{8}-[A-Z,0-9]{6}", "gi"), function() {console.log('*** Matched');return true});
...
deal_id_nbr.addMatch(new RegExp("DEAL-[A-Z]{2}-[0-9]{4}-[0-9]{2}-[0-9]{6}", "gi"), function() {console.log('*** Matched');return true});
